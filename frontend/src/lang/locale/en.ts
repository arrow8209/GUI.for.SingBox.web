export default {
  ...
  kernel: {
    ...
    inbounds: {
      ...
      usersPlaceholder: 'username:password',
      export: 'Export link',
      ...
      vless: {
        ...
        handshakePort: 'Reality Handshake Port',
        privateKey: 'Reality Private Key',
        shortId: 'Short IDs',
        uuidPlaceholder: 'uuid',
      },
      trojan: {
        title: 'Trojan TLS Inbound',
        serverName: 'TLS Server Name',
        alpn: 'ALPN',
        minVersion: 'Min TLS Version',
        maxVersion: 'Max TLS Version',
      ...
      shadowsocks: {
        ...
        method: 'Method',
        password: 'Password',
        generateFailed: 'Failed to call sing-box to generate password, random bytes used instead',
      },
      custom: {
        label: 'Paste inbound JSON (one per card)',
        placeholder: 'Enter a JSON object describing a single inbound',
        mustObject: 'Inbound JSON must be a single JSON object',
      },
