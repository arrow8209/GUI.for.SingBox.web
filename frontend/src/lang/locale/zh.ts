  ...
  kernel: {
    ...
    inbounds: {
      ...
      vless: {
        ...
        serverName: 'TLS 域名',
        handshakeServer: 'Reality 回落地址',
        handshakePort: 'Reality 回落端口',
      ...
      shadowsocks: {
        ...
        method: '加密方式',
        password: '密码',
        generateFailed: '调用 sing-box 生成密码失败，已改用本地随机值',
      },
      custom: {
        label: '自定义入站 JSON（每个卡片一个）',
        placeholder: '输入一个描述单个入站的 JSON 对象',
        mustObject: '请输入合法的 JSON 对象',
      },
      mixedPort: '混合代理端口',
